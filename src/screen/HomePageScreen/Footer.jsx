...
function Footer() {
  return (
    <>
      <footer className="footer bg-gradient-to-b from-[#1d1d1d] to-[#041c31] text-gray-200 p-10 pt-16">
      ...
      <footer className="footer footer-center p-4 bg-[#041c31] text-gray-400 border-t border-neutral-800">
        <aside>
